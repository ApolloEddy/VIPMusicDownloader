Public Class RandomUserAgent
	Public ReadOnly ComputerUAs As String() =
	{
	...
	Public ReadOnly HandphoneUAs As String() =
	{
	...
	Public ReadOnly Property NextComputerUA() As String
		Get
			Return ComputerUAs(rand.Next(0, ComputerUAs.Count - 1))
		End Get
	End Property
	Public ReadOnly Property NextHandphoneUA() As String
		Get
			Return HandphoneUAs(rand.Next(0, ComputerUAs.Count - 1))
		End Get
	End Property
End Class
